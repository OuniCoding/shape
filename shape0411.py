...
class ShapeAnalysis:
    ...
    def analysis(self, frame):
        ...
        ret, binary = cv.threshold(blur, 64, 255, cv.THRESH_BINARY) # | cv.THRESH_OTSU) #50 40
        # canny = cv.Canny(blur, 127, 255)
...
#                shape_type = "矩形"
        ...
        cv.imwrite("p2-test-result.png", frame)
...
if __name__ == "__main__":
    ...
    image_org = cv.imread('p2.jpg')  # ('cap/1red-5050.jpg') # ('447.bmp') #("result64.jpg") #('a-test.png') #
